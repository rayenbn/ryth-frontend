    ...
    <div className="row justify-content-md-center">
        <div className="col-lg-10 col-md-10 mb-4">
            <div className="card user-profile o-hidden mb-4 " style={{boxShadow: 'unset'}}>
                <div className="header-cover" id="startup-cover" style={{backgroundImage: `url(${coverImg})`}}>
                   
                    <button className="btn btn btn-outline-primary upload-cover-button m-2" style={{position:'absolute',right: '10px',display: 'flex',zIndex: '9'}} type="button">
